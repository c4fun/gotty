...
[release]: https://github.com/c4fun/gotty/releases
[wercker]: https://app.wercker.com/project/bykey/03b91f441bebeda34f80e09a9f14126f
[license]: https://github.com/c4fun/gotty/blob/master/LICENSE
...
Download the latest stable binary file from the [Releases](https://github.com/c4fun/gotty/releases) page. Note that the release marked `Pre-release` is built for testing purpose, which can include unstable or breaking changes. Download a release marked [Latest release](https://github.com/c4fun/gotty/releases/latest) for a stabale build.
...
See the [`.gotty`](https://github.com/c4fun/gotty/blob/master/.gotty) file in this repository for the list of configuration options.
